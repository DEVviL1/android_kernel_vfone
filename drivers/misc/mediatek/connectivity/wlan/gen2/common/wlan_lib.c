...
WLAN_STATUS wlanLoadManufactureData(IN P_ADAPTER_T prAdapter, IN P_REG_INFO_T prRegInfo)
{
	...
	FccTxPwrAdjust.Channel_CCK[0] = 12;	/* [0] for start channel, Bug1925175 */
	FccTxPwrAdjust.Channel_CCK[1] = 13;	/* [1] for ending channel */
	FccTxPwrAdjust.Channel_HT20[0] = 12;	/* [0] for start channel, Bug1925175 */
	FccTxPwrAdjust.Channel_HT20[1] = 13;	/* [1] for ending channel */
	FccTxPwrAdjust.Channel_HT40[0] = 8;	/* [0] for start channel,engineer mode ch9(2452), Bug1925175 */
