...
static void init_lcm_registers(void)
{
	...
	data_array[2]= 0x1B3F362F;
	data_array[3]= 0x0C0A073C;
	data_array[4]= 0x14120E16;
	data_array[5]= 0x10061413;
	data_array[6]= 0x05001612;
	data_array[7]= 0x3F362F0A;
	data_array[8]= 0x0A073C1B;
	data_array[9]= 0x120E160C;
...
static void lcm_init(void)
{
	...
	init_lcm_registers();
	LCD_DEBUG("uboot:pop455_hx8395a_fhd_dsi_vdo_truly_lcm_init\n");
}
...
//	set_gpio_lcd_enp(0);
 //   MDELAY(50);	
  ...
  //  SET_RESET_PIN(0);
    //MDELAY(20);
    LCD_DEBUG("uboot:pop455_hx8395a_fhd_dsi_vdo_truly_lcm_suspend\n");
...
//	set_gpio_lcd_enn(1);
   // MDELAY(10);
    ...
    //push_table(lcm_initialization_setting_ty, sizeof(lcm_initialization_setting_ty) / sizeof(struct LCM_setting_table), 1);
    init_lcm_registers();
    LCD_DEBUG("uboot:pop455_hx8395a_fhd_dsi_vdo_truly_lcm_resume\n");
...
LCM_DRIVER pop455_hx8395a_fhd_dsi_vdo_truly_lcm_drv =
{
    .name           = "pop455_hx8395a_fhd_dsi_vdo_truly",
