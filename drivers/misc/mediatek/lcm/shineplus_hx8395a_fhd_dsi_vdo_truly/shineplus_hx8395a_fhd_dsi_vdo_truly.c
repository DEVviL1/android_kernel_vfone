...
*/
	//push_table(lcm_initialization_setting_ty, sizeof(lcm_initialization_setting_ty) / sizeof(struct LCM_setting_table), 1);
	lcm_init();
	LCD_DEBUG("kernel:pop455_hx8395a_fhd_dsi_vdo_truly_lcm_resume\n");
...
LCM_DRIVER shineplus_hx8395a_fhd_dsi_vdo_truly_lcm_drv =
{
    .name           = "shineplus_hx8395a_fhd_dsi_vdo_truly",
