...
/*task 672927 modify by zhanyong.yin at 20151029 begin*/
...
*/
	...
	*a_pu2Result = (read_data(0x03) << 8) + (read_data(0x04) & 0xff);
	...
	printk("[DW9800AF]  s4DW9800AF_ReadReg %d\n", *a_pu2Result);
...
{
	int  i4RetValue = 0;
	//LOG_INF("[DW9800AF]  s4DW9800AF_write reg %d\n", a_u2Data);
...
/*task 672927 modify by zhanyong.yin at 20151029 end*/
...
{	
	...
	if (*g_pAF_Opened == 2) {
		LOG_INF("Wait\n");
               /*modify by jinlin.hu for fix af driver ic dw9800 have electric leakage problem. Start*/
               //s4AF_WriteReg(0x80); /* Power down mode */
               /*modify End.*/

		/*Add by jinlin.Hu for set dw9800 to Power down mode. Start*/
