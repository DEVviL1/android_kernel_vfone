	...
	if (1) {
		...
		if (node) {
			...
			/* name = of_get_property(node, "MAIN_CAMERA_POWER_A", NULL); */
			 regSubVCAMD = regulator_get(sensor_device, "vgp3"); /*check customer definition*/
			if (regSubVCAMD == NULL) {
			    if (regVCAMA == NULL) {
			    ...
			    if (regVCAMAF == NULL) {
				    regVCAMAF = regulator_get(sensor_device, "vldo28");
			    }
			} else{
...
//add by yinzhanyong at 20151119 begin
char Front_Camera_Name[256]="NA:NA:NA:0";
...
char Back_Camera_Name[256]="NA:NA:NA:0";
...
//add by yinzhanyong at 20151119 end
/*******************************************************************************
 * i2c relative start
********************************************************************************/
/*******************************************************************************
...
Create_Camera_node_ForMMI(); //add by yinzhanyong at 20151119
