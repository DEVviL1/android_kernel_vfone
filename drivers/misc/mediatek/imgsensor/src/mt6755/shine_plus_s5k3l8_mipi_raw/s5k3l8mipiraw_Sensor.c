 ...
 *  15080409230000: pass!
 -------------------------------
 @DateTime:    20151104154744
 * modify bug:winsizeinfo[5]>[10] ; tuning shading para; last setdummy line2256
 -------------------------------
 @DateTime:    20151110190244
 * modify the setdummy problem......
 *------------------------------------------------------------------------------
...
/****************************   Modify end    *******************************************/
extern void s5k3l8_otp_cali(void);
extern void s5k3l8_read_pdaf(void);
extern int s5k3l8_OTP_Flag;
extern int s5k3l8_pdaf_Flag;
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		s5k3l8_read_pdaf();
					...
					sprintf(Back_Camera_Name,"S5K3L8:Sunny:SUP2:13M_AF");  
					if((s5k3l8_OTP_Flag==1)&&(s5k3l8_pdaf_Flag==1)){
                             ...
                             UINT8 *feature_para,UINT32 *feature_para_len)
{
    ...
    switch (feature_id) {
		...
		case SENSOR_FEATURE_GET_PDAF_DATA:	
			...
			s5k3l8_read_otp_pdaf_data((kal_uint16 )(*feature_data),(char*)(uintptr_t)(*(feature_data+1)),(kal_uint32)(*(feature_data+2)));
