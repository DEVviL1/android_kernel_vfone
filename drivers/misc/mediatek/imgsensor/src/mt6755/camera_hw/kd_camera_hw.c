...
#define CONTROL_AF_POWER 0//task851352 modify by zhanyong.yin at 20151119
...
PowerUp PowerOnList = {
	{
	/*task672927 modify by zhanyong.yin at 20150929 begin*/
	{SENSOR_DRVNAME_OV13853_MIPI_RAW,
	 ...
	 /*task672927 modify by zhanyong.yin at 20150929 end*/
	 ...
	 /*task672924 modify by zhanyong.yin at 20150929 begin*/
	 ...
	 /*task672924 modify by zhanyong.yin at 20150929 end*/
...
int mtkcam_gpio_set(int PinIdx, int PwrType, int Val)
{
	...
	case RST:
		...
		/*task851352 modify by zhanyong.yin at 20151119 begin*/
			/*if (Val == 0 && !IS_ERR(cam2_rst_l))
				...
				PK_ERR("%s : pinctrl err, PinIdx %d, Val %d, RST\n", __func__,PinIdx ,Val);*/
		/*task851352 modify by zhanyong.yin at 20151119 end*/
		}
		break;
	case PDN:
		if (PinIdx == 0) {
...
{
/*task 672927 modify by zhanyong.yin at 20151104 begin*/
	if (pwInfo.PowerType == AVDD) {
		...
		if (PowerCustList.PowerCustInfo[CUST_AVDD].Gpio_Pin == GPIO_UNSUPPORTED) {
			...
			if (mtkcam_gpio_set(pinSetIdx, pwInfo.PowerType, PowerCustList.PowerCustInfo[CUST_AVDD].Voltage)) {
			 ...
			 mtkcam_gpio_set(pinSetIdx, AVDD,1);
                printk("enable AVDD LDO PIN\n");

	}
	/*task 672927 modify by zhanyong.yin at 20151104 end*/
	...
	/*task851352 modify by zhanyong.yin at 20151119 begin*/
	mtkcam_gpio_set(pinSetIdx, AF_EN_PIN,1);
	/*task851352 modify by zhanyong.yin at 20151119 end*/
#if CONTROL_AF_POWER
...
/*task 672927 modify by zhanyong.yin at 20151104 begin*/
	if (pwInfo.PowerType == AVDD) {
		...
		{
			mtkcam_gpio_set(pinSetIdx, AVDD,0);
	       
                printk("disable AVDD LDO PIN\n");
	...
	/*task851352 modify by zhanyong.yin at 20151119 begin*/
	mtkcam_gpio_set(pinSetIdx, AF_EN_PIN,0);
	/*task851352 modify by zhanyong.yin at 20151119 end*/
#if CONTROL_AF_POWER
		if (PowerCustList.PowerCustInfo[CUST_AFVDD].Gpio_Pin == GPIO_UNSUPPORTED) {
