...
/*modify by yinzhanyong at 20151226 begin*/
...
/*modify by yinzhanyong at 20151226 end*/
...
stCAM_CAL_LIST_STRUCT g_camCalList[] = {
	{OV13853_SENSOR_ID, 0xA0, CMD_AUTO, cam_cal_check_mtk_cid},
...
unsigned int cam_cal_check_mtk_cid(struct i2c_client *client, cam_cal_cmd_func readCamCalData)
{
	...
	if (readCamCalData != NULL) {
		readCamCalData(client, 1, (unsigned char *)&calibrationID, 1);//modify by yinzhanyong at 20151226
