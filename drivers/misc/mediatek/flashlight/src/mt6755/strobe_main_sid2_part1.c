...
static int FL_Enable(void)
{
    ...
    PK_DBG("FL_Enable-"); //task672921 modify by zhanyong.yin at 20150928
...
{
    flashDisable_LM3643_2(); //task672921 modify by zhanyong.yin at 20150928
...
{
    setDuty_LM3643_2(duty); //task672921 modify by zhanyong.yin at 20150928
    return 0;
}
...
{
	FlashIc_Disable(); //task672921 modify by zhanyong.yin at 20150928
    return 0;
}
...
static int constant_flashlight_ioctl(unsigned int cmd, unsigned long arg)
{
	...
	int iow_shift;
	int iowr_shift;
	//kal_uint8 valTemp;//task672921 modify by zhanyong.yin at 20150928
	ior_shift = cmd - (_IOR(FLASHLIGHT_MAGIC,0, int));
	iow_shift = cmd - (_IOW(FLASHLIGHT_MAGIC,0, int));
	iowr_shift = cmd - (_IOWR(FLASHLIGHT_MAGIC,0, int));
	PK_DBG("LM3643_LED2_constant_flashlight_ioctl() line=%d ior_shift=%d, iow_shift=%d iowr_shift=%d arg=%d\n",__LINE__, ior_shift, iow_shift, iowr_shift, (int)arg);//task672921 modify by zhanyong.yin at 20150928
    switch(cmd)
    {
	...
	case FLASH_IOC_SET_TIME_OUT_TIME_MS:
    	...
    	case FLASH_IOC_SET_DUTY :
			...
			m_duty2 = arg; //task672921 modify by zhanyong.yin at 20150928
    		break;
