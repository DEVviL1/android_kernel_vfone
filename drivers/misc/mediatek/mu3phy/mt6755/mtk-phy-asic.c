...
#endif
    /*add for usb eye pattern begin*/
	U3PhyWriteField32((phys_addr_t) (uintptr_t) U3D_USBPHYACR1, RG_USB20_VRT_VREF_SEL_OFST, RG_USB20_VRT_VREF_SEL, 6);//for tun driver i
	U3PhyWriteField32((phys_addr_t) (uintptr_t) U3D_USBPHYACR1, RG_USB20_TERM_VREF_SEL_OFST, RG_USB20_TERM_VREF_SEL, 6); //for tun driver v 
    /* add for usb eye pattern end */
	/*Wait 800 usec */
	udelay(800);
