...
extern int fts_i2c_Read(struct i2c_client *client, u8*writebuf,int writelen, u8 *readbuf, int readlen);
extern int fts_i2c_Write(struct i2c_client *client, u8 *writebuf, int writelen);
...
#define TPD_POWER_SOURCE_CUSTOM         1
...
#define TPD_KEYS_DIM            	{{172,2000,20,TPD_BUTTON_HEIGH}, {826,2000,20,TPD_BUTTON_HEIGH}}
