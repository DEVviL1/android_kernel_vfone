...
static unsigned char CTPM_FW[] = {
	//#include "POP4_5.5_VF_5436_ID80_V30_20151127_app.i"
	//#include "POP4_5.5_VF_5436_ID80_V31_20151231_app.i"
	//#include "test1_POP4_5.5_VF_5436_ID80_V32_20160202_app.i"
	//#include "POP4_5.5_VF_5436_ID80_V32_20160224_app.i"
	#include "POP4_5.5_VF_5436_ID80_V33_20160414_app.i"
...
int fts_ctpm_fw_upgrade_with_i_file(struct i2c_client *client)
{
	...
	*/
	dev_err(&client->dev, "%x:", fts_updateinfo_curr.CHIP_ID);
...
int fts_ctpm_auto_upgrade(struct i2c_client *client)
{
	...
	if (/*the firmware in touch panel maybe corrupted */
		...
		msleep(100);
			printk("*******fts_ctpm_auto_upgrade:jjj******\n");
