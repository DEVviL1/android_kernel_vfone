...
const int g_TpVirtualKey[] = {TOUCH_KEY_MENU, TOUCH_KEY_BACK,TOUCH_KEY_HOME};
...
const int g_TpVirtualKeyDimLocal[MAX_KEY_NUM][4] = {{172,2000,BUTTON_W,BUTTON_H},
                                                    {826,2000,BUTTON_W,BUTTON_H}};
#endif 
