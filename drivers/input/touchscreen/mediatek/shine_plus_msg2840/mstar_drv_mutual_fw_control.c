 ...
 */
//#include "msg28xx_xxxx_update_bin.h" // for MSG26xxM
//#include "msg28xx_xxxx_update_bin.h"

//#include "msg28xx_xxxx_update_bin.h" // for MSG28xx
//#include "msg28xx_xxxx_update_bin.h"
//#include "SHINEPLUS_VF_MSG2840_JUNDA_0X2.004.h"
#include "SHINEPLUS_VF_MSG2840_JUNDA_0X2.006.h"
...
void _DrvFwCtrlMsg26xxmCheckFirmwareUpdateBySwId(void)
{
    ...
    if (nCrcMainA == nCrcMainB && nCrcInfoA == nCrcInfoB) // Case 1. Main Block:OK, Info Block:OK
    {
        ...
        if (eSwId == MSG26XXM_SW_ID_XXXX)
        {
            ...
            nUpdateBinMajor = msg28xx_xxxx_update_bin[0][0x2B]<<8 | msg28xx_xxxx_update_bin[0][0x2A];
            nUpdateBinMinor = msg28xx_xxxx_update_bin[0][0x2D]<<8 | msg28xx_xxxx_update_bin[0][0x2C];
#else // By one dimensional array
            nUpdateBinMajor = msg28xx_xxxx_update_bin[0x002B]<<8 | msg28xx_xxxx_update_bin[0x002A];
            nUpdateBinMinor = msg28xx_xxxx_update_bin[0x002D]<<8 | msg28xx_xxxx_update_bin[0x002C];
#endif
        }
